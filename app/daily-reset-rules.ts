/**
 * Arcadia's daily window starts at 09:00 in the operator's reference timezone
 ...
 */
export const DAILY_RESET_HOUR_LOCAL = 9;
export const DAILY_RESET_OFFSET_UTC_HOURS = 3;
export const DAILY_RESET_HOUR_UTC =
  DAILY_RESET_HOUR_LOCAL + DAILY_RESET_OFFSET_UTC_HOURS;
export const DAILY_RESET_OFFSET_MS = DAILY_RESET_HOUR_UTC * 60 * 60 * 1000;
